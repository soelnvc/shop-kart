  ...
  return (
    <aside className="flex w-full flex-col border-b border-gray-200 bg-white px-6 py-5 lg:min-h-screen lg:w-60 lg:border-b-0 lg:border-r lg:px-5 lg:py-8">
      <div className="flex h-full flex-col">
        ...
        <nav className="mt-8 flex gap-2 lg:flex-col" aria-label="Main navigation">
          <Link to="/home" className="rounded-md px-3 py-2 text-sm font-medium text-gray-900 transition-colors hover:bg-gray-100">
            Home
          </Link>
